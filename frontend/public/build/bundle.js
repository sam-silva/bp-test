...
var app = (function () {
    ...
    * */
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(section, file$5, 25, 4, 722);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(25:0) {#if $movies.length > 0}",
    		ctx
    	});
    ...
    // (27:8) {#each $movies as movie, i (movie.id)}
    function create_each_block$2(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(27:8) {#each $movies as movie, i (movie.id)}",
    		ctx
    	});
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<CardSection> was created with unknown prop '${key}'`);
    	});
    ...
    // (26:8) <Button              disable={(isEdit() && $inputErrorStore) || false}              click={isEdit() ? saveUpdates : goEdit}>
    function create_default_slot_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(26:8) <Button              disable={(isEdit() && $inputErrorStore) || false}              click={isEdit() ? saveUpdates : goEdit}>",
    		ctx
    	});
    ...
    function create_default_slot$3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(33:8) <Button click={goShow}>",
    		ctx
    	});
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$8, 24, 4, 795);
    			attr_dev(div1, "class", "flex justify-center mb-2");
    			add_location(div1, file$8, 23, 0, 751);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$b($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$1.warn(`<ButtonsShowMovie> was created with unknown prop '${key}'`);
    	});
    ...
    class ButtonsShowMovie extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*movieId*/ ctx[5] === undefined && !("movieId" in props)) {
    			console_1$1.warn("<ButtonsShowMovie> was created without expected prop 'movieId'");
    		}
    	}
      ...
      "children": [
        {
          ...
          "ext": "svelte",
          "badExt": false,
          "absolutePath": "/mnt/c/Users/samue/Documents/apache/bp-tasktwo/frontend/src/pages/index.svelte",
        ...
        },
        {
          ...
          "ext": "",
          "badExt": false,
          "absolutePath": "/mnt/c/Users/samue/Documents/apache/bp-tasktwo/frontend/src/pages/movie",
          "children": [
            {
              "isFile": true,
              "isDir": false,
              ...
              "ext": "svelte",
              "badExt": false,
              "absolutePath": "/mnt/c/Users/samue/Documents/apache/bp-tasktwo/frontend/src/pages/movie/_layout.svelte",
            ...
            },
            {
              ...
              "ext": "",
              "badExt": false,
              "absolutePath": "/mnt/c/Users/samue/Documents/apache/bp-tasktwo/frontend/src/pages/movie/[movieId]",
              "children": [
                {
                  "isFile": false,
                  "isDir": true,
                  ...
                  "ext": "",
                  "badExt": false,
                  "absolutePath": "/mnt/c/Users/samue/Documents/apache/bp-tasktwo/frontend/src/pages/movie/[movieId]/edit",
                  "children": [
                    {
                      "isFile": true,
                      "isDir": false,
                      ...
                      "ext": "svelte",
                      "badExt": false,
                      "absolutePath": "/mnt/c/Users/samue/Documents/apache/bp-tasktwo/frontend/src/pages/movie/[movieId]/edit/index.svelte",
                ...
                },
                {
                  ...
                  "ext": "svelte",
                  "badExt": false,
                  "absolutePath": "/mnt/c/Users/samue/Documents/apache/bp-tasktwo/frontend/src/pages/movie/[movieId]/index.svelte",
